...
<InlineCode>source ~/.mavenrc</InlineCode> to load Maven. To automatically load Maven,
follow these steps:
...
This will automatically load the Maven path variables into your
<InlineCode>$PATH</InlineCode> everytime you start a new Bash section.
